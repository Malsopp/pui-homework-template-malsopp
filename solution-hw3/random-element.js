...
// selecting the current base price to make additional calculations based on 
let currentPrice = document.getElementsByClassName ("indvPrice")

// updating the total price based on the glazing price and packing price
...
// call the price to be updated when specialized glazing is chosen
function updateGlazing() {
    glazingPrice = parseFloat(selectglazing.value);
    updateTotalPrice();
}

// call the price to be updated when the pack size is chosen
